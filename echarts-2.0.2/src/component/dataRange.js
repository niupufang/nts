    ...
    DataRange.prototype = {
        ...
        _buildItem : function () {
            ...
            if (this.dataRangeOption.orient == 'vertical'
                ...
                && !this.dataRangeOption.textOpposite //#002
            ) {
            ...
            for (var i = 0; i < dataLength; i++) {
                ...
                if (needValueText) {
                    ...
                    textShape = {
                        ...
                        style : {
                            x : lastX + itemWidth + 5,
                            y : lastY + (this.dataRangeOption.textStyle.paddingTop || 0), //#002
        ...
        _getItemShape : function (x, y, width, height, color) {
            return {
                ...
                style : {
                    ...
                    y : y + 1,
                    width : width,
                    height : this.dataRangeOption.forceHeight ? height : height - 2, //#001
                    color : color
                },
                highlightStyle: {
                    strokeColor: color,
        ...
        getColor : function (value) {
            if (typeof this.dataRangeOption.getColor === 'function') {
                return this.dataRangeOption.getColor(value);
            }
