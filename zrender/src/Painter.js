...
define(
    function (require) {
        ...
        Painter.prototype.clearLayer = function (k) {
            ...
            // modLayer 会改变this._zLevelConfig的值
            // 这里没有在zrender中看到外部接口，估计是在echarts中用到
            ...
            if (zLevelConfigK) {
                ...
                //如果该层从来没有配置过_zLevelConfig，那就调用clearRect之
